(function(){
  ...
  angular
    ...
    function ListController(){
        var vm = this;
        this.footer = "Developed & Designed by : Christopher Rutledge while using pure HTML, CSS, and AngularJS"
        vm.data = turtlesData;
        vm.activeTurtle ={};
    ...
    var turtlesData = [
        ...
        },
        {
            ...
            image_url: "https://images7.alphacoders.com/410/410838.jpg",
        ...
        },
        {
            ...
            image_url: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Common_snakeneck_turtle_(Chelodina_longicollis)_2.jpg",
